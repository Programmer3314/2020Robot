...
public class BarrelRunAuto extends WaypointAuto{
    ...
    public void setWaypoints() {
        ...
        waypoints.add(new WaypointGyro(0.3 * 1.6, 0.14 * 1.6, 339)); //FORWARD CIRCLE TURN RIGHT
        waypoints.add(new WaypointDistance(0.6, 0, 7)); //FORWARD

        waypoints.add(new WaypointGyro(0.3 * 1.4, -0.13 * 1.4, -285 + 360)); //-288//FORWARD CIRCLE TURN LEFT
        waypoints.add(new WaypointDistance(0.6, 0, 5.0)); //FORWARD
        waypoints.add(new WaypointDistance(0.5, 0, 1.0)); //1.5//FORWARD (SLOW DOWN)

        waypoints.add(new WaypointGyro(0.3 * 1.6, -0.15 * 1.6, -495 + 360)); //FORWARD CIRCLE TURN LEFT
        waypoints.add(new WaypointGyro(0.4 * 1.6, 0.05 * 1.6, -540 + 360)); //ADJUSTMENT TURN RIGHT
